...
import { ElDialog, ElForm, ElFormItem, ElInput, ElInputNumber, ElSelect, ElOption, ElButton } from "element-plus";
...
const formRules = {
  ...
  homeId: [
    { required: true, message: "请输入家庭ID", trigger: "blur" }
  ],
  roomId: [
