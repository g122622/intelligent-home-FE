    ...
    <el-card>
      ...
      <div class="debug-section">
        ...
        <div class="test-items">
          ...
          <div class="test-item">
            <span>访客按钮: </span>
            <el-button v-perms="{ role: 'guest' }" size="small"
              >访客专属</el-button
            >
            <span class="status">{{
              hasGuestPermission ? "可见" : "隐藏"
            }}</span>
          </div>
        </div>
      </div>
...
const canAccessDemo = computed(
  () => hasRole("owner") || hasRole("member") || hasRole("guest")
);
